...
static const struct imx385_regval imx385_1080p30_settings[] = {
	...
	{ 0x3013, 0x01 },
	{ 0x3014, 0x07 }, //Gain
	{ 0x3018, 0x65 }, // VMAX low byte for 30 fps at HMAX=0x1130.
	{ 0x3019, 0x04 },
	{ 0x301b, 0x30 },
	{ 0x301c, 0x11 },
	{ 0x3020, 0x02 }, //SHS1
...
static int imx385_set_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	case V4L2_CID_HBLANK:
		ret = imx385_set_hmax(imx385, imx385->current_mode->width + ctrl->val);
		break;
